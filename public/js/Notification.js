...
var app4 = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#app-4',
  data: {
    todos: [{
...
var app7 = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#app-7',
  data: function data() {
    return {
      name: '',
  ...
  methods: {
    postData: function postData(e) {
      ...
      e.preventDefault();
      var currentObj = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/api/formSubmit', {
        name: this.name,
        email: this.email,
        phone: this.phone
